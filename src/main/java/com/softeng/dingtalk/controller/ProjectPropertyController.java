...
public class ProjectPropertyController {
    ...
    public void addProjectPropertyFile(@RequestParam MultipartFile file,@PathVariable int id,@PathVariable String type){
        projectPropertyService.addProjectPropertyFile(file,id,type);
    }
