...
public class InternalPaperPo implements PaperPo {
    /**
     * 论文的投稿结果
     */
    ...
    private List<PaperDetailPo> paperDetails;
    ...
    public InternalPaperPo(int id) {
        this.id = id;
    }

    public InternalPaperPo(String title, String journal, PaperType paperType, LocalDate updateDate,
