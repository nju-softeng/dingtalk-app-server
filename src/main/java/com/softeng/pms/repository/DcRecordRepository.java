...
import com.softeng.pms.vo.AppliedVO;
import com.softeng.pms.vo.CheckedVO;
import com.softeng.pms.vo.DcVO;
...
public interface DcRecordRepository extends CustomizedRepository<DcRecord, Integer> {
     ...
     **/
    @Query("select new com.softeng.pms.vo.CheckedVO(d.id, d.applicant.name, d.applicant.id, d.dvalue, d.cvalue, d.dc, d.ac, d.yearmonth, d.week, d.insertTime, d.weekdate) " +
     ...
     **/
    @Query("select new com.softeng.pms.vo.ToCheckVO(d.id, d.applicant.id, d.applicant.name, d.dvalue, d.yearmonth, d.week, d.insertTime, d.weekdate) from DcRecord d where d.auditor.id = :uid and d.status = false order by d.id desc")
     ...
     * @return
     */
    @Query("select new com.softeng.pms.vo.DcVO(d.dateCode, d.dc) from DcRecord d where d.applicant.id = :uid and d.auditor.id = :aid and d.dateCode >= :begin and d.dateCode <= :end")
     ...
     *
     **/
    @Query("select new com.softeng.pms.vo.AppliedVO(d.id, d.auditor.id, d.auditor.name, d.status, d.dvalue, d.dc, d.ac, d.yearmonth, d.week, d.weekdate, d.insertTime) " +
